...
public:
	// 27. Remove Element
	/*=====================================================================
	 * Description: Given an array nums and a value val, remove all
	 *	instances of that value in-place and return the new length. Do
	 *	not allocate extra space for another array, you must do this by
	 *	modifying the input array in-place with O(1) extra memory. The
	 *	order of elements can be changed. Doesn't matter what you leave
	 *	beyond the new length.
	 *
	 * Example:
	 *	Input: [3,2,2,3], val = 3	Output: 3
	 *	Explination: Your function should return length = 2, with the
	 *	first two elements of nums being 2. It doesn't matter what you
	 ...
	 *	first five elements of nums containing 0, 1, 3, 0, and 4. Note
	 *	that the order of those five elements can be arbitrary. It does
	 *	not matter what values are set beyond the returned length.
	 *
	 * Clarification:
	 ...
	 *	well. Internally you can think of this:
	 *      1. nums is passed in by reference. (without making a copy) int
